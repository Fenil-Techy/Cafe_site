...
export const Header=()=>{
    ...
    return(
            ...
            <nav className="sticky top-0 z-50 flex justify-between items-center px-2 py-1 bg-[#0b727b] border">
                <div className="pl-3">
                ...
                <div className={
                    ...
                    fixed top-0 right-0 w-64 h-full bg-[#0b727b] shadow-2xl transform transition-transform duration-300 z-50
                    `}>
